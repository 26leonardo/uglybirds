...
//TO DO: stampa classifica 
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==buttonBackToStartMenu){
            ...
            MainGUI.getInstance().flip("START_MENU");   //me lo faceva pigiare due volte per funzionare, poi ho invertito l ordine delle due righe qui e ha funzionato (prima questa stava sopra)
        }
    }
