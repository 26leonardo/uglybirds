...
public class Images{
    ...
    public static final int YELLOW_BIRD=26;
    public static final int BLUE_BIRD=27;
    public static final int WHITE_BIRD=28;

    public static final int NUMBER_OF_IMAGES=29;
    
    static Image[] imagesArray=null;
    //static ImageIcon arrowGif;
    ...
    public static void loadImages(){
        try{
            ...
            //arrowGif = new ImageIcon("../media/img/arrow.gif");
        }catch(IOException e){
