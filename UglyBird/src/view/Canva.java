...
public class Canva extends JPanel implements /*ActionListener,*/ MouseListener, MouseMotionListener{
    ...
    public void drawBird(String s, Graphics2D g2){    
        if(s == "red")
    ...
    public void drawExplosion(Point p, Graphics2D g2){
        ...
        int x = p.x-(MainGUI.EXPLOSION_SIZE-IView.BLOCK_SIZE)/2;  //per centrare l'esplosione
    ...
    public void drawDoubleExplosion(Point p1, Point p2, Graphics2D g2){
        int x1 = (p1.x+p2.x)/2-(MainGUI.EXPLOSION_SIZE-IView.BLOCK_SIZE)/2;  //per centrare l'esplosione
