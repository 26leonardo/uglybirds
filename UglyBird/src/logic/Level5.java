...
public class Level5 extends Level{
    public Level5(){
        ...
        blocksPositions[5]=new Point(ZERO_ROW,FLOOR-IView.BLOCK_SIZE-IView.BLOCK_SIZE-IView.BLOCK_SIZE);
        blocksPositions[6]=new Point(ZERO_ROW,FLOOR-IView.BLOCK_SIZE-IView.BLOCK_SIZE-IView.BLOCK_SIZE-IView.BLOCK_SIZE);
    }
