...
public class Level4 extends Level {
    public Level4(){
        ...
        pigsPositions[3]=new Point(FIRST_ROW, FLOOR-IView.PIG_SIZE-IView.BLOCK_SIZE-IView.PIG_SIZE);

        blocksPositions[0]=new Point(FIRST_ROW,FLOOR);  
        blocksPositions[1]=new Point(FIRST_ROW,FLOOR-IView.PIG_SIZE-IView.BLOCK_SIZE);
        ...
        blocksPositions[5]=new Point(THIRD_ROW,FLOOR-IView.BLOCK_SIZE);
    }
